...
export default function BiometricScanning() {
  ...
  return (
    <div className="biometric-screen">
      ...
      <div className="biometric-icon scanning">
      ...
      <h2 className="biometric-title">Escaneando...</h2>
      <p className="biometric-subtitle">Mantente quieto mientras verificamos tu identidad</p>
    </div>
  )
}
